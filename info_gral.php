                    ...
                    <div class="card-body">
                        <form action="alta.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3 text-center">
                                ...
                                <input type="file" class="form-control-file" name="Imagen" accept="image/gif, image/jpeg, image/jpg, image/png" /><br>
                            </div>
                            <div class="mb-3">
                                <!--<label for="Id_Usuario" class="form-label">Usuario</label>-->
                                <input type="hidden" class="form-control" name="Id_Usuario" id="Id_Usuario" value="<?php echo $id_usuario; ?>">
                            </div>
                            <div class="mb-3">
                                <label for="Id_Categoria" class="form-label">Seleccione una categoría</label>
                                <select class="form-select" aria-label="categorias" name="Id_Categoria" id="categorias" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="direcciones" name="Id_Direccion" id="direcciones" required>
                                    
                                </select>
                            </div>
                            <div class="mb-3 ">
                                <label for="Nombre" class="form-label">Nombre de la empresa</label>
                                <input type="text" class="form-control" name="Nombre" placeholder="Ingrese el nombre de su empresa" id="Nombre" required>
                            </div>
                            <div class="mb-3">
                                <label for="Telefono" class="form-label">Número telefónico</label>
                                <input type="tel" class="form-control" name="Telefono" placeholder="Ingrese su número telefónico" id="Telefono" pattern="[0-9]{10}" required title="10 Dígitos">
                            </div>
                            <div class="mb-3">
