        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    <center>
                        <h1 class="mt-4">Eliminar oferta</h1>
                        <h6>Todochef Teziutlán</h6><br>

                        <div class="card text-center">
                            <div class="card-header">

                                <img src="delete.png" width="40" height="40"><br>

                            </div>
                            <div class="window-notice" id="window-notice">
                                <div class="content">
                                    <div class="content-text">¿Desea eliminar definitivamente?<p>
                                    </div>
                                </div>

                                <div style="width:100%; height:100%">
                                    <a class="btn btn-outline-success" href="info_ofertas.php" role="button">Si</a>
                                    <a class="btn btn-outline-danger" href="info_ofertas.php" role="button">No</a>
                                    <p>
                    </center>
                </div>
        </div>
